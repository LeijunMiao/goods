...
namespace goods
{
    public partial class OutOrderList : Form
    {
        ...
        public void loadData(int Index)
        {
            ...
            dtData = ctrl.getOutOrders(pagingCom1.PageIndex, pagingCom1.PageSize,
            ...
            pagingCom1.RecordCount = ctrl.getOutOrderCount(this.dateTimePicker1.Checked, this.dateTimePicker1.Value.Date, textBox2.Text, textBox3.Text);
            pagingCom1.reSet();
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                OutOrderView view = new OutOrderView(dataGridView1.SelectedRows[0].Cells["单据编码"].Value.ToString());
                view.Show();
            }
            else
            {
